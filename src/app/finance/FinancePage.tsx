...
import { PRIMARY_TABS, SECONDARY_TABS, SUB_ACTION, type PrimaryTab } from './_constants';
...
export default function FinancePage() {
  ...
  return (
    <Box>
      ...
      {primaryTab === 'reports'   && <ReportsSection   {...sectionProps} />}
      {primaryTab === 'inventory' && <InventorySection {...sectionProps} />}
